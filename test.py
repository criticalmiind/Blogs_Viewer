...
browser = webdriver.Chrome(chrome_driver_path, desired_capabilities = cap, options=options)

browser.get("http://localhost:8080/spiderincome/redirect.php?link=http://localhost:8080/spiderincome/test.php")

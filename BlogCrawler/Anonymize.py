...
class Anonymize():
    ...
    def generate_user_agent(self):
        ...
        switcher = {
            1: "Mozilla/5.0 " + self.firefox(),
            2: "Mozilla/5.0 " + self.safari(),
            3: "Mozilla/" + self.rand(4, 5) + ".0 " + self.iexplorer(),
            4: "Opera/" + self.rand(8, 9) + '.' + self.rand(10, 99) + ' ' + self.opera(),
            5: 'Mozilla/5.0' + self.chrome()
        }
